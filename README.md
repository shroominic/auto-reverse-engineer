...
- `tactics/`: RE domain knowledge — target-type playbooks, analysis patterns, conjecture templates, and anti-patterns (one file per topic)
...
4. It copies `program.md` and `tactics/` into that project folder.
...
- consult `tactics/` playbooks when seeding paths or choosing between approaches
